		...
		btnUsunP.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					JOptionPane.showMessageDialog(Main.this, "Pracownik usuniï¿½ty", "Usunieto",
...
////////////////////////////////////////////////////////////////////////////////////// Wlasciciele TAB
		...
		btnSzukajWlasciciele.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				try {
					...
					if (imieWTextField.getText().equals("Imiê")) {
						imie = "";
					}
		...
		imieWTextField.setToolTipText("Imiê");
		imieWTextField.setText("Imiê");
		...
		miejscowoscWTextField.setToolTipText("Miejscowoœæ");
		miejscowoscWTextField.setText("Miejscowoœæ");
		...
		btnUsunW.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					// wyswietl potwierdzenie
					JOptionPane.showMessageDialog(Main.this, "Wlasciciel usuniêty", "Usunieto",
							JOptionPane.INFORMATION_MESSAGE);
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// Blok Tab
		...
		//
		// //wyswietl potwierdzenie
		// JOptionPane.showMessageDialog(Main.this, "Wlasciciel usuniêty",
